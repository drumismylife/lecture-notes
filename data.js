      ...
      courses: {
        ...
        greek2: {
          ...
          weeks: [
            { week: 1, title: "오리엔테이션 + 복습1 — 알파벳·억양·음절, 동사(1-1) 현재 능동, 명사 2변화·관사, 명사 1변화", date: "2026.06.29", files: [
                { type: "notes", label: "강의노트", href: "output/2026-summer/greek2/week01.html" }
            ] },
            ...
            { week: 5, title: "단축동사(직설법) · 지시대명사", date: "2026.06.30", files: [
            { type: "notes", label: "강의노트", href: "output/2026-summer/greek2/week05.html" }
          ] },
        ...
        worship: {
          ...
          weeks: [
            ...
            { week: 5, title: "교회력의 이해와 예배 기획", date: "2026.06.30", files: [
            { type: "notes", label: "강의노트", href: "output/2026-summer/worship/week05.html" }
          ] },
      ...
      courses: {
        ...
        hist2: {
          ...
          weeks: [
            ...
            { week: 3, title: "제6부 종교개혁과 개신교의 시대 (1517-1648) - 3주차", date: "2026.09.15", files: [
            { type: "notes", label: "강의노트", href: "output/2026-2/hist2/week03.html" }
          ] },
            { week: 4, title: "4주차 쯔빙글리와 칼빈의 종교개혁", date: "2026.09.22", files: [
